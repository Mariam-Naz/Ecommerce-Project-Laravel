                  ...
                  <div class="modal-dialog">
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
                                 <form class="form-horizontal" method='post' enctype="multipart/form-data" action={{url('/admin/view-product/'.$product->id)}}> @csrf
                                    <fieldset>
                                       ...
                                       <div class="col-md-4 form-group">
                                         ...
                                         <div class="form-group col-md-12">
                                          ...
                                          <img src="{{asset('uploads/product/'.$product->image)}}"alt={{$product->image}} width="100" height="100" style='margin-bottom:5px;'>
                                          @endif
